...
NAKSHATRAS = {
    "Овен": [
        ("Ашвини", 0.0, 13.3333, [(0.0, 3.3333), (3.3333, 6.6667), (6.6667, 10.0), (10.0, 13.3333)]),
        ("Бхарани", 13.3333, 26.6667, [(13.3333, 16.6667), (16.6667, 20.0), (20.0, 23.3333), (23.3333, 26.6667)]),
        ("Криттика", 26.6667, 30.0, [(26.6667, 30.0)]),
    ],
    "Телец": [
        ("Криттика", 0.0, 10.0, [(0.0, 3.3333), (3.3333, 6.6667), (6.6667, 10.0)]),
        ("Рохини", 10.0, 23.3333, [(10.0, 13.3333), (13.3333, 16.6667), (16.6667, 20.0), (20.0, 23.3333)]),
        ("Мригашира", 23.3333, 30.0, [(23.3333, 26.6667), (26.6667, 30.0)]),
    ],
    "Близнецы": [
        ("Мригашира", 0.0, 6.6667, [(0.0, 3.3333), (3.3333, 6.6667)]),
        ("Ардра", 6.6667, 20.0, [(6.6667, 10.0), (10.0, 13.3333), (13.3333, 16.6667), (16.6667, 20.0)]),
        ("Пунарвасу", 20.0, 30.0, [(20.0, 23.3333), (23.3333, 26.6667), (26.6667, 30.0)]),
    ],
    "Рак": [
        ("Пунарвасу", 0.0, 3.3333, [(0.0, 3.3333)]),
        ("Пушья", 3.3333, 16.6667, [(3.3333, 6.6667), (6.6667, 10.0), (10.0, 13.3333), (13.3333, 16.6667)]),
        ("Ашлеша", 16.6667, 30.0, [(16.6667, 20.0), (20.0, 23.3333), (23.3333, 26.6667), (26.6667, 30.0)]),
    ],
    "Лев": [
        ("Магха", 0.0, 13.3333, [(0.0, 3.3333), (3.3333, 6.6667), (6.6667, 10.0), (10.0, 13.3333)]),
        (
            "Пурва-Пхалгуни", 13.3333, 26.6667,
            [(13.3333, 16.6667), (16.6667, 20.0), (20.0, 23.3333), (23.3333, 26.6667)]),
        ("Уттара-Пхалгуни", 26.6667, 30.0, [(26.6667, 30.0)]),
    ],
    "Дева": [
        ("Уттара-Пхалгуни", 0.0, 10.0, [(0.0, 3.3333), (3.3333, 6.6667), (6.6667, 10.0)]),
        ("Хаста", 10.0, 23.3333, [(10.0, 13.3333), (13.3333, 16.6667), (16.6667, 20.0), (20.0, 23.3333)]),
        ("Читра", 23.3333, 30.0, [(23.3333, 26.6667), (26.6667, 30.0)]),
    ],
    "Весы": [
        ("Читра", 0.0, 6.6667, [(0.0, 3.3333), (3.3333, 6.6667)]),
        ("Свати", 6.6667, 20.0, [(6.6667, 10.0), (10.0, 13.3333), (13.3333, 16.6667), (16.6667, 20.0)]),
        ("Вишакха", 20.0, 30.0, [(20.0, 23.3333), (23.3333, 26.6667), (26.6667, 30.0)]),
    ],
    "Скорпион": [
        ("Вишакха", 0.0, 3.3333, [(0.0, 3.3333)]),
        ("Анурадха", 3.3333, 16.6667, [(3.3333, 6.6667), (6.6667, 10.0), (10.0, 13.3333), (13.3333, 16.6667)]),
        ("Джиештха", 16.6667, 30.0, [(16.6667, 20.0), (20.0, 23.3333), (23.3333, 26.6667), (26.6667, 30.0)]),

    ],
    "Стрелец": [
        ("Мула", 0.0, 13.3333, [(0.0, 3.3333), (3.3333, 6.6667), (6.6667, 10.0), (10.0, 13.3333)]),
        ("Пурва-Ашадха", 13.3333, 26.6667, [(13.3333, 16.6667), (16.6667, 20.0), (20.0, 23.3333), (23.3333, 26.6667)]),
        ("Уттара-Ашадха", 26.6667, 30.0, [(26.6667, 30.0)]),
    ],
    "Козерог": [
        ("Уттара-Ашадха", 0.0, 10.0, [(0.0, 3.3333), (3.3333, 6.6667), (6.6667, 10.0)]),
        ("Шравана", 10.0, 23.3333, [(10.0, 13.3333), (13.3333, 16.6667), (16.6667, 20.0), (20.0, 23.3333)]),
        ("Дхаништха", 23.3333, 30.0, [(23.3333, 26.6667), (26.6667, 30.0)]),
    ],
    "Водолей": [
        ("Дхаништха", 0.0, 6.6667, [(0.0, 3.3333), (3.3333, 6.6667)]),
        ("Шатабхиша", 6.6667, 20.0, [(6.6667, 10.0), (10.0, 13.3333), (13.3333, 16.6667), (16.6667, 20.0)]),
        ("Пурва-Бхадрапада", 20.0, 30.0, [(20.0, 23.3333), (23.3333, 26.6667), (26.6667, 30.0)]),
    ],
    "Рыбы": [
        ("Пурва-Бхадрапада", 0.0, 3.3333, [(0.0, 3.3333)]),
        ("Уттара-Бхадрапада", 3.3333, 16.6667, [(3.3333, 6.6667), (6.6667, 10.0), (10.0, 13.3333), (13.3333, 16.6667)]),
        ("Ревати", 16.6667, 30.0, [(16.6667, 20.0), (20.0, 23.3333), (23.3333, 26.6667), (26.6667, 30.0)]),
    ]
}
